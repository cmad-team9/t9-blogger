...
public interface Blogger {
	...
	void addBlog(Blog blog) throws InvalidBlogException,DuplicateBlogException, BloggerException;
	...
	List<BlogComment> getAllComments(int blogId,int offset,int pageSize,String sortOrder) throws BlogNotFoundException, BloggerException;
